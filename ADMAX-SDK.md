...
| 1.0.3	 | 2018/09/04| 김재형 |포스트백 완료 후 광고주 메세지, 집계 혹은 페이지 이동을 위한 이벤트 처리 가이드 추가|
| 1.0.4	 | 2018/10/19	 | 김재형 |연동 상세 내용 보강|
| 1.0.5	 | 2018/12/28 | 김재형 |연동 상세 내용 추가 및 사용자 IP 항목 처리 제거|
